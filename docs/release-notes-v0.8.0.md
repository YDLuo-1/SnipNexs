...
- Regression coverage includes text composition and undo, RGB/HEX copying, distinct Text/OCR icons, 13 icon-only toolbar actions, and DPI-aware selection dimensions.
